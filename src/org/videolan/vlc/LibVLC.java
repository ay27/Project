...
public class LibVLC {
    ...
    public String getSubtitlesEncoding() {
        final SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(ProjectApplication.instance);
    ...
    public boolean timeStretchingEnabled() {
        SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(ProjectApplication.instance);
