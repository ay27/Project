...
public class LibVLC {
    ...
    public static synchronized void useIOMX(Context context) {
    	...
    	sUseIomx = false;
    	setAout(context, "error", false);
    }
    
    public String getSubtitlesEncoding() {
        //final SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(DemeterApplication.getAppContext());
    ...
    public boolean timeStretchingEnabled() {
       // SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(DemeterApplication.getAppContext());
